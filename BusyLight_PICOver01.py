# ---------------------------------------------------------------------
# BusyLight_PICOver01.py
# ======================
#
# Prvni,jednoducha ukazka reseni "BusyLight" za pouziti desky Raspberry
# Pi Pico. Jako svetelny majak pouzit kruh 16-ti RGB LED WS2812B. Ovla-
...
# 
# vytvoreno:       06.07.2022 (RKu70cz)
# verze:           1.00
# posledni uprava: 09.07.2022 (RKu70cz)
#
# (c) 2022, RKu70cz
# ---------------------------------------------------------------------
...
numLEDs = 16              # pocet LEDek pasku resp. kruhu
